...
export default function WorkoutCardView({workout_name, setCount, repCount, totalExercises}){
    return(
        <LinearGradient
            ...
            <View style={[Styles.sub_container_horizontal, {width: '95%'}]}>
                ...
                <Image style={Styles.iconLarge} source={
                    workout_name.toLowerCase() === "chest day" || workout_name.toLowerCase() === "push day" ? require('../assets/icons/chest-day-white.png') :
                        workout_name.toLowerCase() === "back" || workout_name.toLowerCase() === "pull day" ? require("../assets/icons/back-day-white.png") :
            ...
            <View style={[Styles.sub_container_horizontal, {width: '95%'}]}>
                <Button text={"Edit"} customStyle={{width: '35%', height: 35}} textStyle={{fontSize: 18}} />
                <Button text={"Delete"} customStyle={{width: '35%', height: 35}} textStyle={{fontSize: 18}}/>
            </View>
        </LinearGradient>
    )
}